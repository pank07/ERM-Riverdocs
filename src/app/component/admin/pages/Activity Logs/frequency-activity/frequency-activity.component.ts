...
@Component({
  ...
  templateUrl: './frequency-activity.component.html',
  styleUrls: ['./frequency-activity.component.css']
})
export class FrequencyActivityComponent implements OnInit {
  activityData: any[] = [];
  displayedData: any[] = [];
  searchQuery: string = '';
  ...
  getActivityData(): void {
    this.api.getfrequencyactivity().subscribe((res: any) => {
 ...
 downloadCSV() {
  const headers = ['Name', 'Status', 'Description', 'Created At', 'Updated At'];
